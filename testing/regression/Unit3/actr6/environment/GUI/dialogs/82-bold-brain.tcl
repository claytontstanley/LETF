...
proc make_bold_brains {} {
  ...
  if {[winfo exists .bold_slices] == 1} {
    wm deiconify .bold_slices
    focus -force .bold_slices
  } else {


  set win [toplevel .bold_slices]
...
$win.frame.canvas create rectangle 446 450 456 460   -width 0 -fill ""  -outline "" -tag {box aural}
  ...
  checkbutton $win.show -text "Show box borders" -variable brain_borders  -font checkbox_font -command "toggle_borders"
 ...
 set brain_data ""
  ...
  send_environment_cmd \
      "create list-handler $win.frame brain_data \
         (lambda (x) (declare (ignore x)) (list \"XXX\" \"XXX\")) ()"
...
proc toggle_borders {} {
  ...
  if {$brain_borders == 1} {
   .bold_slices.frame.canvas itemconfigure box -width 1
  } else {
   .bold_slices.frame.canvas itemconfigure box -width 0
  }
}
